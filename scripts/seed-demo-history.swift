...
func buildDemoItems() throws -> [DemoItem] {
    ...
    return [
        DemoItem(
            ...
            isFavorite: false, isPassword: false, passwordComment: "", passwordLogin: "", passwordURL: ""
        ),
        DemoItem(
            id: UUID(),
            copiedAt: ago(11),
        ...
        DemoItem(
            ...
            isFavorite: true, isPassword: false, passwordComment: "", passwordLogin: "", passwordURL: ""
        ),
        DemoItem(
            id: UUID(),
            copiedAt: ago(82),
        ...
        DemoItem(
            ...
            passwordURL: "https://github.com/settings/tokens"
        ),
        DemoItem(
            id: UUID(),
            copiedAt: ago(155),
            ...
            passwordURL: "https://console.aws.amazon.com/iam/"
        ),
        DemoItem(
            id: UUID(),
            copiedAt: ago(170),
...
func writeItem(_ item: DemoItem) throws {
    ...
    if item.isPassword {
        ...
        if !item.passwordURL.isEmpty {
            try writeMeta(item.passwordURL, to: dir.appendingPathComponent("passwordURL"))
        }
    }
